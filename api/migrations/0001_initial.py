# Generated by Django 3.0.5 on 2021-09-01 16:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(db_index=True, help_text='Введите категорию произведения.', max_length=200, unique=True, verbose_name='Категория произведения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(db_index=True, help_text='Введите название жанра', max_length=200, unique=True, verbose_name='Название жанра')),
                ('slug', models.SlugField(unique=True, verbose_name='URL')),
            ],
            options={
                'verbose_name': 'Жанр',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveIntegerField(blank=True, db_index=True, help_text='Год выпуска', null=True, validators=[django.core.validators.MinValueValidator(1800), api.models.max_value_current_year], verbose_name='Год выпуска')),
