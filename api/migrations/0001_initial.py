    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.DecimalField(blank=True, decimal_places=0, help_text='Год выпуска', max_digits=4, null=True, verbose_name='Год выпуска')),
...
# <<<<<<< HEAD
#                 ('genre', models.ManyToManyField(related_name='Genre', to='api.Genre', verbose_name='Жанр')),
# =======
...
#             },
#         ),
# >>>>>>> 5132d858bce3322202776c7544c651bfef4d2cd1
    ]
